CONFIGS_ = {
    ...
    #'cifar': ([32, 'M', 64, 'M', 96, 'M', 'F'], 3, 10, 1563, 128),
    'cifar10': ([], 3, 10, 0, 32),
    'cifar100-c100':([],3, 100 , 0 ,64),
    ...
    'fashion_mnist': ([6, 16, 'F'], 1, 10, 784, 32),
...
GENERATORCONFIGS = {
    ...
    #'cifar': (512, 128, 3, 10, 128),
    'cifar10': (256, 32, 3, 10, 32),

    # 'twoVisualData':(16,8,1,3,8),
    'twoVisualData': (64, 2, 1, 4, 16),

    'cifar100-c100': (512, 64, 3, 100, 64),
    'celeb': (128, 32, 3, 2, 32),
    'mnist': (256, 32, 1, 10, 32),
    'fashion_mnist': (256, 32, 1, 10, 32),
