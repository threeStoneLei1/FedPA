...
class User:
    ...
    def init_loss_fn(self):
        ...
        self.L2_distanLoss = L2_distanLoss(batchsize = self.batch_size)
...
class L2_distanLoss(nn.Module):
    ...
    def forward(self, tensor1, tensor2):
        ...
        l2_distances1 = torch.norm(tensor1 - tensor2, p='fro')
        l2_distances2 = torch.norm(tensor1 - tensor2, p=2)
        l2_distances3 = l2_distances1 / self.batch_size
